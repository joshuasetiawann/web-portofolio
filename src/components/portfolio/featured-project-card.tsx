      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden md:aspect-auto md:min-h-72">
        <m.div variants={interactive ? coverVariants : undefined} className="absolute inset-0">
          {project.cover ? (
            ...
            <div
              aria-hidden="true"
              className="h-full w-full border border-border bg-surface-1 bg-[linear-gradient(to_right,var(--grid-line)_1px,transparent_1px),linear-gradient(to_bottom,var(--grid-line)_1px,transparent_1px)] bg-[size:32px_32px]"
            />
          )}
        </m.div>
      </div>
